          ...
          <section id="profile">
            ...
            <div class="section__text">
              ...
              <div id="socials-container">
                <img
                  src="/static/resumes/Modern/assets/linkedin.png"
                  alt="My LinkedIn profile"
                  class="icon"
                  onclick="location.href='https://linkedin.com/'"
                />
                <img
                  src="/static/resumes/Modern/assets/github.png"
              ...
              <div class="about-details-container">
                <div class="about-containers">
                  <div class="details-container">
                    <img
                      src="/static/resumes/Modern/assets/experience.png"
                      alt="Experience icon"
                      class="icon"
                    />
                    <h3>Experience</h3>
                  ...
                  <div class="details-container">
                    <img
                      src="/static/resumes/Modern/assets/education.png"
                      alt="Education icon"
                      class="icon"
                    />
                    <h3>Education</h3>
                  ...
                  ${
                    res?.skills?.map((data)=>{
                      return(
                        `<article>
                        <img
                          src="/static/resumes/Modern/assets/checkmark.png"
                          alt="Experience icon"
                          class="icon"
                        />
                        <div>
          ...
          <section id="contact">
            ...
            <div class="contact-info-upper-container">
              <div class="contact-info-container">
                <img
                  src="/static/resumes/Modern/assets/email.png"
                  alt="Email icon"
